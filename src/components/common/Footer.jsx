  ...
  return (
    <>
      <div className='bg-[#d7b56d] w-full'>
        <div className='container m-auto grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ps-10 sm:ps-0 sm:justify-around sm:items-start pt-16 pb-6 Roboto-Bold text-[#000]'>
          <ul>
          ...
          <ul className='pt-7 sm:pt-0'>
            ...
            <li className='flex SourceSans3-Black'><FaPhoneAlt /><span className='Roboto-Light ps-2 pr-1'> 9929298644 </span> (Rupkishor Nehra)</li>
