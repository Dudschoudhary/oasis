...
const WelcomeSection = () => {
  return (
    <>
      <div className='container m-auto Roboto-Bold mb-9 flex justify-center items-center md:items-start flex-col md:flex-row'>
         <div className='w-full md:w-[50%] p-4'>
            <img src={schoolStudents} alt="school students Image " className='rounded' data-aos="flip-right" data-aos-easing="ease-out-cubic"  data-aos-duration="2000"/>
         </div>
         <div className='w-full md:w-[50%] p-4' >
